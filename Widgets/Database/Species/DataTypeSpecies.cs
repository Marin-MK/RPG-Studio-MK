...
namespace RPGStudioMK.Widgets
{
    public class DataTypeSpecies : Widget
    {
        ...
        public DataTypeSpecies(IContainer Parent) : base(Parent)
        {
            ...
            HPLabel.SetFont(f);
            HPLabel.SetText("HP");
            NumericSlider HPSlider = new NumericSlider(Stats1);
            ...
            NumericSlider AttackSlider = new NumericSlider(Stats1);
            ...
            NumericSlider DefenseSlider = new NumericSlider(Stats1);
            ...
            NumericSlider SpAtkSlider = new NumericSlider(Stats2);
            ...
            NumericSlider SpDefSlider = new NumericSlider(Stats2);
            ...
            NumericSlider SpeedSlider = new NumericSlider(Stats2);
