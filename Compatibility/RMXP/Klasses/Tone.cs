...
namespace RPGStudioMK.Compatibility
{
    public static partial class RMXP
    {
        public static class Tone
        {
            ...
            public static int Gray(IntPtr Self)
            {
                return (int) Ruby.Float.FromPtr(Ruby.GetIVar(Self, "@gray"));
            }
            ...
            static IntPtr _dump(IntPtr Self, IntPtr Args)
            {
                ...
                Ruby.Array.Set(array, 3, Ruby.GetIVar(Self, "@gray"));
                Ruby.Unpin(array);
            ...
            static IntPtr initialize(IntPtr Self, IntPtr Args)
            {
                ...
                if (len >= 4)
                {
                    ...
                    if (Ruby.Array.Is(Args, 3, "Integer")) Gray = Ruby.Float.ToPtr(Ruby.Integer.FromPtr(Ruby.Array.Get(Args, 3)));
                    else Gray = Ruby.Array.Get(Args, 3);
                }
                Ruby.SetIVar(Self, "@red", Red);
                Ruby.SetIVar(Self, "@green", Green);
                Ruby.SetIVar(Self, "@blue", Blue);
                Ruby.SetIVar(Self, "@gray", Gray);
                return Ruby.Nil;
            }
        }
    }
