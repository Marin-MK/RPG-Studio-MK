...
public partial class DataTypeTMs : DataTypeBase
{
	...
	public override void Initialize()
	{
        ...
        TMList.SetContextMenuList(new List<IMenuItem>()
        {
            ...
            new MenuItem("Paste")
            {
                IsClickable = e => e.Value = TMList.HoveringItem is not null && Clipboard.IsValid(BinaryData.TMS),
                OnClicked = PasteTM
            },
			new MenuSeparator(),
            new MenuItem("Delete")
    ...
    void CopyTM(BaseEventArgs e)
	{
        ...
        Item tm = HoveringTM;
        Clipboard.SetObject(tm, BinaryData.TMS);
    }
    ...
    {
        if (TMList.HoveringItem is null || !Clipboard.IsValid(BinaryData.TMS)) return;
